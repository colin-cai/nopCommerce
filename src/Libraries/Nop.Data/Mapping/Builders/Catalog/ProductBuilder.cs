    ...
    public partial class ProductBuilder : NopEntityBuilder<Product>
    {
        ...
        public override void MapEntity(CreateTableExpressionBuilder table)
        {
            table
                ...
                .WithColumn(nameof(Product.PriceFormula)).AsString(2000).Nullable()
                .WithColumn(nameof(Product.FlatLength)).AsString(400).Nullable()
                .WithColumn(nameof(Product.FlatWidth)).AsString(400).Nullable();
        }
